...
def calculate_complex_roots(a, b, c):
    ...
    root_1 = # this will need to be the plus half of the quadratic
    root_2 = # this will need to be the minus half of the quadratic
    return root_1, root_2
# Test your function
print(calculate_complex_roots(1, 1, 1))  # Should print (3.0, 2.0)